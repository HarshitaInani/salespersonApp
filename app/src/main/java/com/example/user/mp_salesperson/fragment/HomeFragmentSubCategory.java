...
public class HomeFragmentSubCategory extends Fragment {
    ...
    HomeFragSubCategoryRecyclerViewAdapter mHomeFragSubCategoryRecyclerViewAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (mBaseCatSubCatBean != null && (!mBaseCatSubCatBean.getmBaseCatBeanArrayList().isEmpty() && baseCategoryId != -1)) {
            ...
            if (isListFound) {
                ...
                try {
                  mHomeFragSubCategoryRecyclerViewAdapter = new HomeFragSubCategoryRecyclerViewAdapter(getActivity(), mCategoryBeanArrayList, rowIMageHeight, rowIMageWidth, getFragmentManager());
