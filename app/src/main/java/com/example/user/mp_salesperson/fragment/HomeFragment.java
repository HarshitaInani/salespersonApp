    ...
    public class GetCategorySubCategory extends AsyncTask<String, Void, JSONObject> {
      /*  *//*Dialog mDialog;
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            ComplexPreferences mRetailerBeanPref = ComplexPreferences.getComplexPreferences(getContext(), Constant.RETAILER_BEAN_PREF, getContext().MODE_PRIVATE);
            RetailerBean mRetailerBean = mRetailerBeanPref.getObject(Constant.RETAILER_BEAN_PREF_OBJ, RetailerBean.class);

            try {
                jsonObjectFromUrl = new HttpUrlConnectionJSONParser().getJsonObjectFromHttpUrlConnection(Constant.BASE_URL_ITEM_MASTER + "?warehouseid=" +mRetailerBean.getWarehouseId(), null, HttpUrlConnectionJSONParser.Http.GET);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public class GetPopularBrands extends AsyncTask<String, Void, JSONArray> {
       ...
       Dialog mDialog;
        ...
        protected JSONArray doInBackground(String... params) {
            ...
            RetailerBean mRetailerBean = mRetailerBeanPref.getObject(Constant.RETAILER_BEAN_PREF_OBJ, RetailerBean.class);
            try {
                jsonArrayFromUrl = new HttpUrlConnectionJSONParser().getJsonArrayFromHttpUrlConnection(Constant.BASE_URL_BRAND_PROMOTION + "?warehouseid=" +mRetailerBean.getWarehouseid(), null, HttpUrlConnectionJSONParser.Http.GET);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return jsonArrayFromUrl;
