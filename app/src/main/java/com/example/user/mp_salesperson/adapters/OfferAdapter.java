...
public class OfferAdapter extends RecyclerView.Adapter<OfferAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(OfferAdapter.ViewHolder viewHolder, final int i) {
       ...
       // System.out.println("Image::"+Constant.BASE_URL_Images1 + mAllTopAddedItemArrayList.get(i).getItemNumber() + ".jpg");
            ...
            {
                Picasso.with(context).load(mofferlist.get(i).getOfferLogoUrl()).into(viewHolder.img_android);
            }
            else
                {
                Picasso.with(context).load(Constant.BASE_URL_Images1 + mofferlist.get(i).getNumber() + ".jpg").into(viewHolder.img_android);
