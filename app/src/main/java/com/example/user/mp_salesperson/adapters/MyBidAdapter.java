...
public class MyBidAdapter extends RecyclerView.Adapter<MyBidAdapter.ViewHolder> {
    ...
    ArrayList<String> BillingAddress = new ArrayList<>();
      ...
      //  Toast.makeText(context, "Adapter Array"+jsonArray.toString(), Toast.LENGTH_SHORT).show();
        ...
        try {
            for (int j = 0; j < jsonArray.length(); j++) {
                ...
                BillingAddress.add(jsonObject.getString("BillingAddress"));
...
//          viewHolder.tvName.setText("Get name");
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Address=BillingAddress.get(i).toString();
                ...
                Utility.setStringSharedPreference(context, "BillingAddress", Address);
