...
public class BeatOrderActivity extends AppCompatActivity {
    ...
    String skCode, rewardpoint, skCodeCId, skCodeCName,lat,longi,name,BillingAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Intent i = getIntent();
       ...
       /*  skCode = i.getStringExtra("MyBeatSkCode");
        ...
        BillingAddress=   Utility.getStringSharedPreferences(context,"BillingAddress");




        System.out.println("skCode:::"+skCode);
        address.setText("Customer Address = "+BillingAddress);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (id == R.id.action_my_orders) {
                            ...
                            startActivity(new Intent(BeatOrderActivity.this, CustomerRegistration.class));
