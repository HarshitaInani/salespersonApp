...
/*    private void ShowPopup(int totalAmount) {
        ...
        if(totalAmount >= 4000 && totalAmount <= 5000) {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 9000 & totalAmount <= 10000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 14000 & totalAmount <= 15000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 19000 & totalAmount <= 20000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 24000 & totalAmount <= 25000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 29000 & totalAmount <= 30000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 34000 & totalAmount <= 35000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 39000 & totalAmount <= 40000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 44000 & totalAmount <= 45000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else if(totalAmount >= 49000 & totalAmount <= 50000)
        {
            show_popup.setVisibility(View.VISIBLE);
            show_popup.setText(R.string.left_free_dial);
        }else{
