...
//                conn.setRequestMethod("POST");
    ...
    public synchronized JSONObject getJsonFromHttpUrlConnectionJsonRequest_Post(String url, JSONObject mJsonObject) {
        ...
        Log.d(getClass().getName(), "Response get in string format\nURL: " + url + "\nPARAMS: " + mJsonObject + "\nREPSONSE: " + resp);
    ...
    public synchronized JSONArray getJsonArrayFromHttpUrlConnection(String url, List<NameValuePair> params, Http method) {
        String resp;
        Log.d(getClass().getName(), "URL: " + url + "\nPARAMS: " + params + "\nREPSONSE: in processing...");
        if (method == Http.GET) {
            resp = getResponseFromHttpGet(url, params);
        ...
        try {
            ...
            if (json instanceof JSONObject) {
                jObj = new JSONArray("[{Error:Not a valid jsonArray}]");
            } else if (json instanceof JSONArray) {
                jObj = new JSONArray(resp);
            }
        } catch (JSONException e) {
            Log.e("JSON Parser", "Error parsing object ");
            e.printStackTrace();
